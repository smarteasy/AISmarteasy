...
public class IndexDefinition
{
    ...
    {
        string indexName = name ?? PineconeUtils.DEFAULT_INDEX_NAME;

        return Create(indexName)
            .WithDimension(PineconeUtils.DEFAULT_DIMENSION)
            .WithMetric(PineconeUtils.DEFAULT_INDEX_METRIC)
            .NumberOfPods(1)
            .NumberOfReplicas(1)
            .WithPodType(PineconeUtils.DEFAULT_POD_TYPE)
